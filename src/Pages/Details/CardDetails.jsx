...
const CardDetails = () => {
    ...
    return (
        <div>
            ...
            {
                loading ? 'loading' :
                    <div className=' w-8/12 m-auto my-9'>
                        <div className="card  bg-base-100 shadow-xl">
                            ...
                            <div className="card-body   mx-10">
                                <h2 className="card-title">{cardData?.estate_title}</h2>
                                ...
                                <div className="">
                                    ...
                                    <ul className=' flex gap-7 flex-col md:flex-row lg:flex-row px- py-4 text-lg font-medium text-gray-500'>
                                        {
