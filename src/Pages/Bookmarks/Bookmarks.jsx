                ...
                <div className='border-2 rounded-md p-5 my-4 space-y-3'>
                    ...
                    {bookMarkData.length <= 0 ? <h1 className=' text-2xl my-6 text-center'>Not bookmarked now</h1> :
                        ...
                        bookMarkData.map(data => <>
                            {
                                <div className="card card-compact lg:w-8/12  m-auto bg-base-100 shadow-xl flex flex-col md:flex-row  lg:flex-row justify-start  animate__animated animate__fadeInRight">
                                    <figure className='rounded-xl lg:w-6/12'><img className='rounded-xl ' src={data.image} alt="Shoes" /></figure>
                                  
                                   <div className=" ">
                                       <div className="card-body md:pl-10">
