...
const Navbar = () => {
    ...
    const navi = <>
        ...
        <NavLink to={'/map'}><li><a>Map</a></li></NavLink>
    ...
    return (
        <div className={`w-full p-0 z-50 fixed top-0 ${visible ? 'top-0 transition-all' : '-top-20 transition-all'} duration-1000`} >
        <div className='navbar  bg-[#18171760] bb-[#ffffff60]  ' data-aos="fade-down"
